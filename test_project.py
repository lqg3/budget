...
def test_Calculator():
    assert project.Calculator.add(2, 1) == 3
    assert project.Calculator.subtract(2, 1) == 1
    assert project.Calculator.divide(3, 1) == 3
    assert project.Calculator.multiply(1, 2) == 2
